...
const Home = () => {
  ...
  useEffect(() => {
    axios
      .get("https://famous-pear-underclothes.cyclic.cloud/fetch-posts")
      .then((res) => {
    ...
    if (token) {
      axios
        .post(
          "https://famous-pear-underclothes.cyclic.cloud/user-auth",
          {
            token,
          },
          {
  ...
  const dbUpVote = (userEmail, postId, liked) => {
    ...
    axios
      .post(
        "https://famous-pear-underclothes.cyclic.cloud/handle-upvote",
        {
          userEmail,
          postId,
        },
  ...
  const dbDownVote = (userEmail, postId) => {
    ...
    axios
      .post(
        "https://famous-pear-underclothes.cyclic.cloud/handle-downvote",
        {
          userEmail,
          postId,
        },
  ...
  const dbDeletePost = (userEmail, postId, postOwner) => {
    if (userEmail === postOwner) {
      axios
        .post(
          "https://famous-pear-underclothes.cyclic.cloud/handle-delete-post",
          {
            userEmail,
            postId,
            postOwner,
  ...
  return (
    <div id="home">
      ...
      <div className="home-center">
        <audio
          src="https://res.cloudinary.com/dgm9yxyho/video/upload/v1690989041/like_yb6wla.mp4"
          ref={likeAudio}
        ></audio>
