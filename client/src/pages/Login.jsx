...
const Login = () => {
  ...
  const handleGoogleClick = () => {
    ...
    signInWithPopup(auth, googleAuthProvider)
      .then((data) => {
        axios
          .post(
            "https://famous-pear-underclothes.cyclic.cloud/register-google-user",
            {
  ...
  const registerUser = (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      axios
        .post(
          "https://famous-pear-underclothes.cyclic.cloud/register-user",
          {
            firstName,
            lastName,
            email,
  ...
  const loginUser = (e) => {
    ...
    axios
      .post(
        "https://famous-pear-underclothes.cyclic.cloud/login-user",
        {
          email,
          password,
        },
